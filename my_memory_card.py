...
questions_list = []
questions_list.append(Question('Какой первый день недели?', 'Понедельник', 'Вторник', 'Суббота', 'Четверг'))
questions_list.append(Question('Какая первая буква алфавита?', 'А', 'Б', 'В', 'Г'))
questions_list.append(Question('Какого цвета нет на флаге России?', 'Зелёного', 'Синего', 'Красного', 'Белого'))
questions_list.append(Question('у меня закончилась фантазия', 'правильный ответ', '.', '.', '.'))
questions_list.append(Question('Я не знаю что писать', ':)', ':(', ':(', ':('))
...
layout_main.setSpacing(25) # пробелы
